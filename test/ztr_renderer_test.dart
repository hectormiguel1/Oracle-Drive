...
void main() {
  testWidgets('ZtrTextRenderer renders singular only by default', (
    WidgetTester tester,
  ) async {
    const text =
        'Creature Comforts{End}{StraightLine}Creature Comforts{End}{Article}an e-pass for{End}{ArticleMany}e-passes for';
  ...
  testWidgets('ZtrTextRenderer renders both when displayMultiple is true', (
    WidgetTester tester,
  ) async {
    const text =
        'Creature Comforts{End}{StraightLine}Creature Comforts{End}{Article}an e-pass for{End}{ArticleMany}e-passes for';
  ...
  testWidgets('ZtrTextRenderer handles missing ArticleMany', (
    WidgetTester tester,
  ) async {
    const text =
        'Creature Comforts{End}{StraightLine}Creature Comforts{End}{Article}an e-pass for';
